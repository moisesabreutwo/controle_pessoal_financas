<div class="sidebar col-md-3">
    <a href="{{ route('receitasGrupo.index')}}">Receitas Grupo</a>
    <a href="{{ route('receitasDetalhe.index')}}">Receitas Detalhe</a>
    <a href="{{ route('receitasClassificacao.index')}}">Classificação Receitas</a>
    <a href="{{ route('despesasGrupo.index')}}">Despesas Grupo</a>
